...
PINOT_BROKER_URL = 'https://broker.pinot.<URL>:443/query/sql'  # Ensure the URL ends with /query/sql
BEARER_AUTH_TOKEN = 'Bearer <token>'  # Replace with your actual Bearer Auth token
